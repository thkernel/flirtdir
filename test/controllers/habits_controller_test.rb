...
class HabitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create habit" do
    assert_difference('Habit.count') do
      post habits_url, params: { habit: { alcohol: @habit.alcohol, drugs: @habit.drugs, profile_id: @habit.profile_id, status: @habit.status, tobacco: @habit.tobacco } }
    end
  ...
  test "should update habit" do
    patch habit_url(@habit), params: { habit: { alcohol: @habit.alcohol, drugs: @habit.drugs, profile_id: @habit.profile_id, status: @habit.status, tobacco: @habit.tobacco } }
