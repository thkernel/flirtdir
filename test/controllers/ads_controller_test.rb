...
class AdsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ad" do
    assert_difference('Ad.count') do
      post ads_url, params: { ad: { content: @ad.content, title: @ad.title, user_id: @ad.user_id } }
    end
  ...
  test "should update ad" do
    patch ad_url(@ad), params: { ad: { content: @ad.content, title: @ad.title, user_id: @ad.user_id } }
